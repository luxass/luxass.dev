...
export function ProjectCard({ project }: Props) {
  ...
  return (
    <a
      ...
      <div className="h-36 flex flex-col justify-between gap-y-2 border border-gray-700 p-4 rounded-xl text-gray-200 hover:bg-gray-800">
        ...
        <div className="flex items-center gap-x-2 text-sm">
          ...
          <div>
            ...
            <span className="pl-1">{project.stars}</span>
          </div>
          <span>•</span>
          <div>
            <svg
