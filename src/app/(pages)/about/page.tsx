...
export default function Page() {
  return (
    <section className="p-3 flex flex-col md:flex-row items-start">
      <div className="flex-1 flex flex-col pr-8 h-[200px]">
        ...
        <p className="text-gray-200 mb-4 flex-1">
          ...
          In my spare time i enjoy learning new technologies and solving problems.
          My preferred tools right now are TypeScript, Rust and React.
          <br />
          <br />
