...
* Optional [React](https://github.com/luxass/eslint-config/blob/main/#react), [UnoCSS](https://github.com/luxass/eslint-config/blob/main/#unocss), [Astro](https://github.com/luxass/eslint-config/blob/main/#astro) support
