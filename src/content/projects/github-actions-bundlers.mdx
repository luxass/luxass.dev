---
handle: github-actions-bundlers
name: github-actions-bundlers
owner: luxass
description: A repository to test github actions with a different set of bundlers
githubUrl: https://github.com/luxass/github-actions-bundlers
---
...
[@vercel/ncc](https://github.com/vercel/ncc) is a command-line tool that compiles a Node.js project into a single file, bundling all its dependencies. It simplifies deployment by creating a compact, self-contained executable that doesn't require separate node\_modules.
...
Published under [MIT License](https://github.com/luxass/github-actions-bundlers/blob/main/LICENSE).
