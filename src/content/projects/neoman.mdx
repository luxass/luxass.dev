...
name: neoman
owner: luxass
description: A small yeoman alternative
githubUrl: https://github.com/luxass/neoman
icon: 📋
---
...
Published under [MIT License](https://github.com/luxass/neoman/blob/main/LICENSE).
